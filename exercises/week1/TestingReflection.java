...
public class TestingReflection {
    ...
    public static void main(String[] args){
        ...
        System.out.println("Reflected classname of UFO Enemy Ship: " + className + "\n");
        ...
        System.out.println("Checking if the class is public: " + Modifier.isPublic(classModifiers) + "\n");
        System.out.println("Checking if the class is interface: " + Modifier.isInterface(classModifiers) + "\n");
        System.out.println("Checking if the class is final: " + Modifier.isFinal(classModifiers) + "\n");
        ...
        System.out.println("Super class is " + classSuper.getName() + "\n");
        //Will return "Super class is java.lang.Object" if no express superclass set
        ...
        for(Method method : classMethods){
            ...
            // Get the method name - gives the single method "setName" in superclass then mthods from "Object".
            // Does not return any methods from class itself as there are none
